...
TITAN_SOCIAL_MENU_REALID = "Show RealID Friends";
TITAN_SOCIAL_MENU_FRIENDS = "Show Friends";
TITAN_SOCIAL_MENU_GUILD = "Show Guild Members";
TITAN_SOCIAL_MENU_ICON = "Show Icon";
