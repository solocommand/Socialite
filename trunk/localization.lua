...
-- default (enUS)
  ...
  TITAN_SOCIAL_MENU_REALID_NOTE = "Show Notes";

  TITAN_SOCIAL_MENU_FRIENDS = "Friends";
  TITAN_SOCIAL_MENU_FRIENDS_SHOW = "Show Friends";
  TITAN_SOCIAL_MENU_FRIENDS_NOTE = "Show Notes";
  ...
  TITAN_SOCIAL_MENU_GUILD_SORT = "Sort";
  TITAN_SOCIAL_MENU_GUILD_SORT_DEFAULT = "Use Guild Roster Sort";
  TITAN_SOCIAL_MENU_GUILD_SORT_NAME = "Name";
  TITAN_SOCIAL_MENU_GUILD_SORT_RANK = "Rank";
  TITAN_SOCIAL_MENU_GUILD_SORT_CLASS = "Class";
  TITAN_SOCIAL_MENU_GUILD_SORT_LEVEL = "Level";
  TITAN_SOCIAL_MENU_GUILD_SORT_ZONE = "Zone";
  TITAN_SOCIAL_MENU_GUILD_SORT_ASCENDING = "Ascending";
  TITAN_SOCIAL_MENU_GUILD_SORT_DESCENDING = "Descending";

  TITAN_SOCIAL_MENU_STATUS = "Show Status As";
  TITAN_SOCIAL_MENU_STATUS_ICON = "Icon";
  TITAN_SOCIAL_MENU_STATUS_TEXT = "Text";
  TITAN_SOCIAL_MENU_STATUS_NONE = "None";
